...
{#if !$ndk.signer}
    <CollapsableDropdown>
        ...
        <ul class="divide-y divide-neutral-800 menu p-0 w-60 rounded-box">
            <div>
                <div class="flex justify-center menu-title">
                    <div class="p-1 text-center text-base font-medium text-base-100-content">Anmelden</div>
                </div>
            </div>
            <div class="p-4">
                <div class="flex justify-center">
                    <div class="flex flex-col gap-2 w-full">
                        <div class="text-center text-xs font-normal">Neu zu Nostr?</div>
                        <LoginGuestButton />
                    </div>
                </div>
            </div>
            <div class="p-4">
                <div class="flex justify-center">
                    <div class="flex flex-col gap-2 w-full">
                        <div class="text-center text-xs font-normal">Schon bei Nostr?</div>
                        <LoginNip07Button />
                        <!-- <LoginNip46Button /> -->
                    </div>
                </div>
